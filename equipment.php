  ...
  <div class="container">
    <section class="category-selection" id="category-selection">
      ...
      <ul>
        <li>
          <figure>
            <img src="./img/homogeniser-category.jpg" alt="An enclosed compact milk pasteurizer">
            <figcaption>
              <h3>Homogenisers</h3>
            </figcaption>
          </figure>
        ...
        <li>
          <figure>
            <img src="./img/pasteurizer-enclosed-category.jpg" alt="An enclosed compact milk pasteurizer">
            <figcaption>
              <h3>Pasteurizers</h3>
            </figcaption>
          </figure>
        ...
        <li>
          <figure>
            <img src="./img/heat-exchangers-category.jpg" alt="An Arsopi heat exchanger with additional generic heat exchanger plates">
            <figcaption>
        ...
        <li>
          <figure>
            <img src="./img/valves-category.jpg" alt="A valve in an isolated environment">
            <figcaption>
              <h3>Valves</h3>
            </figcaption>
          </figure>
        ...
        <li>
          <figure>
            <img src="./img/pumps-category.jpg" alt="A process pump in an isolated environment">
            <figcaption>
              <h3>Pumps</h3>
            </figcaption>
          </figure>
        ...
        <li>
          <figure>
            <img src="./img/other-category.jpg" alt="A milk filling machine">
            <figcaption>
