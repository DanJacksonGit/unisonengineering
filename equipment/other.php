...
<body>
  ...
  <div class="container padding-main">
    ...
    <div class="row">
      <div class="col-md-8">
        <h1 style="text-transform:uppercase;">Miscellaneous Process Equipment</h1>
        <p>
          <strong>
            Unison Engineering Services Ltd. manufacture, distribute and supply a variety of miscellaneous new and used equipment. Inclusive of this is our brand new innovative Water Saver Unit.
          </strong>
        </p>
        <p>
